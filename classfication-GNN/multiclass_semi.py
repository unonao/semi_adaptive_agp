"""
やること
- 複数の node proximity を入力・計算ができるように
- 複数の node proximity による特徴量を用いて model で学習できるように
"""
import sys
import os
import time
...
features_train,features,labels,idx_train,idx_val,idx_test,memory_dataset = load_multi_inductive(config["dataset"],config["agp"])
