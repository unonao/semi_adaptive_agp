...
namespace propagation{
    ...
    public:
        ...
        vector<double>Du_b;
        //vector<double>Du;
        double agp_operation(string dataset_el,string dataset_pl,string dataset,string agp_alg,uint mm,uint nn,int LL,double rmaxx,double alphaa,double tt,Eigen::Map<Eigen::MatrixXd> &feat);
