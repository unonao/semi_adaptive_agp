...
from utils import load_geometric_data,muticlass_f1
...
features,labels,idx_train,idx_val,idx_test,memory_dataset = load_geometric_data(args.datastr, config["dataset"],config["agp"])
